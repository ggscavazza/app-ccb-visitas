...
class AppTheme {
  ...
  static const Color yellowColor =
      Color(0xFFfbc531); // Amarelo - Rise And Shine
  static const Color darkYellowColor =
      Color(0xFFe1b12c); // Amarelo - Nanohanacha Gold
  ...
  static const Color redColor =
      Color(0xFFe84118); // Vermelho - Nasturcian Flower
  static const Color darkWhiteColor =
      Color(0xFFdcdde1); // Branco Gelo - Hint Of Pensive
  static const Color grayColor = Color(0xFF7f8fa6); // Cinza - Blueberry Soda
  static const Color darkGrayColor =
      Color(0xFF718093); // Cinza - Cahin Gang Grey
  static const Color marineBlueColor =
      Color(0xFF273c75); // Azul Marinho - Mazarine Blue
  static const Color darkMarineBlueColor =
      Color(0xFF192a56); // Azul Marinho - Pico Void
